...
#define STRING_SPLASH_LINE1 "PortaPrusa v" STRING_VERSION // will be shown during bootup in line 1
...
#define CUSTOM_MENDEL_NAME "PortaPrusa"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {52.07,51.07,3987.23,97.5}  //89.76 default steps per unit for Ultimaker {78.7402,78.7402,200.0*8/3,760*1.1}
